+++
title = "Residències B-Murals"
date = 2026-08-11
ubicacio = "Planta baixa"
cedible = false
draft = false
logo = "/img/espais/residencia-b-murals-logo.webp"
fotografies = [
...
web = "https://www.bmurals.com/residencies"
xarxes = [
...
**El programa de Residències és un dels eixos fonamentals de l’estratègia de suport a la creació.**

B-MURALS convida artistes de l’art urbà o de diferents disciplines a dur a terme in situ un projecte propi, vinculat a l’espai públic. Les **Residències artístiques B-M**es presenten per convocatòria internacional.

Per a participar de les nostres residències en 2026: [DESCARREGA LAS BASES DE PARTICIPACIÓ](https://www.bmurals.com/s/BMurals_basesdeconvocatora_2025-kkrf.pdf)
